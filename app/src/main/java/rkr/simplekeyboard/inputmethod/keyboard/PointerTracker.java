...
public final class PointerTracker implements PointerTrackerQueue.Element {
    ...
    public String processMotionEvent(final MotionEvent me, final KeyDetector keyDetector) {
        ...
        case MotionEvent.ACTION_POINTER_UP:
            ...
            String actiondone = (keyDetector.detectHitKey(x ,y).toString());
            if (actiondone.substring(0, 6).equalsIgnoreCase("delete")) {
                if (letters.length() > 0)
                    letters = letters.substring(0, letters.length() - 1);
            } else if (actiondone.substring(0, 5).equalsIgnoreCase("space")) {
                letters += " ";
            } else if (actiondone.substring(0, 5).equalsIgnoreCase("shift")) {

            } else if (actiondone.substring(0, 5).equalsIgnoreCase("enter")) {
                letters = "";
            } else {
                letters += actiondone.charAt(0);
            }
            Log.v("Key Detector", letters);
            break;
